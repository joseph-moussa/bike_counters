...
def _encode_dates(X):
    """Encodes the date into new features and returns new feature matrix X.
...
def _merge_external_data(X_initial):
    """Merges existing dataframe with an external one and return the new merged dataframe.
...
def get_estimator():
    ...
    # Use LGBM Regressor
    regressor = LGBMRegressor(learning_rate=0.05, boosting_type='gbdt', n_estimators=2500, max_depth=15)
